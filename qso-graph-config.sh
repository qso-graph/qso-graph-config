...
do_credentials() {
    ...
    dialog --backtitle "$BACKTITLE" \
        --title " Credentials" \
        --msgbox "Credentials are managed via the qso-auth CLI\nor the QSO-Graph Manager desktop app.\n\nCLI examples:\n\n  qso-auth persona add --name ki7mt \\ \n    --callsign KI7MT --start 2018-01-01 \\ \n    --providers eqsl qrz lotw hamqth\n\n  qso-auth creds set ki7mt eqsl\n  qso-auth creds set ki7mt qrz\n  qso-auth creds doctor\n\nDesktop: run qso-graph-manager" 20 58
}
